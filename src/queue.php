                ...
                <div id="queue">
                    <div>
                        <ul class="queueHeader"> 
                            <li>
                                <input id="searchQueue" type="text" class="form-control" style="margin-top: 20px; margin-right: 20px;" placeholder="Search for a Queue">
                            </li>
                            <li>
                                <button class="btn" style="margin-left: 40px;" type="button" onclick="searchForQueue()">
                                    Search
                                </button>
                            </li>
                            <li>
                                <button class="btn" type="button" onclick="setQueueName()">
                                    Create Queue
                                </button>
                            </li>
                            <li>
                                <button class="btn" type="button" onclick="getUserQueues()">
                                    My Queues
                                </button>
                            </li>
                            <li id="manageUsers">
